...
class SizeConfig {
  ...
  double blockSizeHorizontal = 1;
  double blockSizeVertical = 1;
  double _safeAreaHorizontal = 1;
  double _safeAreaVertical = 1;
  double safeBlockHorizontal = 1;
  double safeBlockVertical = 1;
  double profileDrawerWidth = 1;
  double refHeight = 1;
  double refWidth = 1;
